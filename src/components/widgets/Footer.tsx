  ...
  <div class="max-w-7xl mx-auto px-4 sm:px-6">
    <div class="grid grid-cols-12 gap-4 gap-y-8 sm:gap-8 py-8 md:py-12">
      <div class="col-span-12 lg:col-span-4 pr-8">
        {/* Paragraphs with adjusted spacing */}
        <div class="mb-4">
      ...
      <div class="col-span-12 md:col-span-12 lg:col-span-8 flex justify-center items-start gap-4">
      {links.map(({ title, items }, index) => (
       <div
         key={index}
         class="flex flex-col items-center min-w-[calc(33.33%+20px)] max-w-[calc(33.33%+30px)]"
        >
    ...
    {/* Social Icons and Other Footer Content */}
